...
public class ComplexRed extends OpMode {
    ...
    private final Pose scorePose = new Pose(91, 87 ,Math.toRadians(-135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    //test this seems ok
    ...
    private final Pose endPose = new Pose(88, 18, Math.toRadians(-68));// Lowest (Third Set) of Artifacts from the Spike Mark.
